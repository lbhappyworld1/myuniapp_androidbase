...
public class SDK_WebView extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (mEntryProxy == null) {
			FrameLayout rootView = new FrameLayout(SDK_WebView.this);
			// 创建5+内核运行事件监听
			WebviewModeListener wm = new WebviewModeListener(SDK_WebView.this, rootView);
			// 初始化5+内核
			mEntryProxy = EntryProxy.init(SDK_WebView.this, wm);
			// 启动5+内核
			mEntryProxy.onCreate(SDK_WebView.this, savedInstanceState, SDK.IntegratedMode.WEBVIEW, null);
